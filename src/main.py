...
from src.services.snapshot.routers.router_proctoring import router as snapshot_proctoring_router
from src.services.snapshot.routers.router_snapshots import router as snapshot_router
