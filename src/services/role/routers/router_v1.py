...
async def create_role(
    ...
    await role_service.create_role(user=user, role_data=role_data)
...
async def get_role(
    ...
    return await role_service.get_role_by_id(user=user, role_id=role_id)
...
async def patch_role(
    ...
    await role_service.update_role(user=user, role_id=role_id, role_data=role_data)
...
async def delete_role(
    ...
    return await role_service.delete_role_by_id(user=user, role_id=role_id)
